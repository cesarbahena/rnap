...
- workflow: Transcriptome cursor, current TaskRealization records, and SemanticNarrowing clarification threads.
...
- Actor identity: `Tf`.
- Tenant content: GeneFamily, Locus, Allele, Mutation, Transcriptome cursor, current TaskRealization records, and SemanticNarrowing clarification threads.
